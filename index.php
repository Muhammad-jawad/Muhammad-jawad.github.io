                            ...
                            <div class="row g-5">
                                <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="bg-light p-4" style="border-radius: 68% 32% 100% 0% / 0% 75% 25% 100%;">
                                        <img src="img/jaz-001.png" class="img-fluid w-100" style="border-radius: 68% 32% 100% 0% / 0% 75% 25% 100%;" alt="Image">
                                    </div>
                                </div>
                            ...
                            <div class="row g-5">
                                <div class="col-xl-5">
                                    <div class="about-img bg-light p-4 wow fadeInUp" data-wow-delay="0.1s">
                                        <img src="img/jaz-002.png" class="img-fluid w-100" alt="Image">
                            ...
                            <div class="bg-light p-4">
                                <div class="row g-5">
                                    <div class="col-xl-5 wow fadeInUp" data-wow-delay="0.1s">
                                        <p class="mb-4">
                                            I’m always open to discussing new projects, collaboration opportunities, or just chatting about web development and technology. Whether you need a custom website, plugin development, or optimization for your existing platform, I’d love to help.
                                        </p>
                                        <p>
                                            Feel free to reach out via email, phone, or through my social media channels. Let’s create something amazing together! 🚀
                                        </p>
                                    ...
                                    <div class="col-xl-7 wow fadeInUp" data-wow-delay="0.3s">
                                        ...
                                        <div class="d-flex mb-4">
                                            ...
                                            <div>
                                                <h4>Address</h4>
                                                <p class="mb-0">Inland Rd, Birmingham, B24 9TD</p>
                                            </div>
                                        </div>
                                        <div class="d-flex mb-4">
                                            <div class="btn-xl-square bg-primary text-white me-3">
                                            ...
                                            <div>
                                                <h4>Mail Me</h4>
                                                <p class="mb-0">jaaviarshad@gmail.com</p>
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                            <div class="btn-xl-square bg-primary text-white me-3">
                       ...
                       <div class="footer-content h-100 pt-6 ps-6 pb-6">
                            <div class="row g-4 align-items-center">
                                <div class="col-12 text-center">
                                    ...
                                    <a class="btn btn-secondary btn-sm-square me-3" href="https://www.facebook.com/mjawadarshad25/" target="_blank"><i class="fab fa-facebook-f text-white"></i></a>
                                            <a class="btn btn-secondary btn-sm-square me-3" href="https://uk.linkedin.com/in/muhammadjawadarshad" target="_blank"><i class="fab fa-linkedin-in text-white"></i></a>
                                            <a class="btn btn-secondary btn-sm-square mb-0" href="https://github.com/Muhammad-jawad" target="_blank"><i class="fab fa-github text-white"></i></a>
                                    </div>
                                </div>
                                <div class="col-12 text-center">
                                    <span class="text-body">
                                    <i class="fas fa-copyright text-body me-2"></i> <span id="copyright-year"></span>, Muhammad Jawad, All rights reserved.
                                    </span>
                                </div>
                            </div>
                       </div>        
